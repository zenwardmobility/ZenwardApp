...
**P1-E3-S7A — Driver Location & Live Dispatch Tracking — recommended next** (per the P1-E3-S7 work item's own stated expectation). Dispatch Board drag-and-drop (ZD-138 deferred it behind New Trip, now complete) is also fully ready to build whenever prioritized instead — not a launch requirement either way; the click-to-assign Dispatch Board remains fully usable in the meantime.
